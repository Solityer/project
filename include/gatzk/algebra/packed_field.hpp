...
namespace gatzk::algebra
{
    ...
    public:
        ...
        const PackedFieldElement* data() const
        {
            return elements_.data();
        }

        PackedFieldElement* data()
        {
            return elements_.data();
        }

        const PackedFieldElement& operator[](std::size_t index) const
        {
            return elements_[index];
        }
        PackedFieldElement& operator[](std::size_t index)
        {
            return elements_[index];
        }

        const std::vector<PackedFieldElement>& elements() const
        {
            return elements_;
        }
        std::vector<PackedFieldElement>& elements()
        {
            return elements_;
        }
    ...
    void pack_native_field_elements_into(const std::vector<mcl::Fr>& values, PackedFieldBuffer* out);
    void pack_field_elements_into(const std::vector<FieldElement>& values, PackedFieldBuffer* out);
